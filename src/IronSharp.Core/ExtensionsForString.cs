...
namespace IronSharp.Core
{
    public static class ExtensionsForString
    {
        ...
        /// </summary>
        /// <param name="format">The format.</param>
        /// <param name="args">if the string contains tokens like {firstName} and {lastName}, then pass an object with matching property names or use the object initializer syntax - New With {.firstName = "Joe", .lastName = "Smith"}</param>
        /// <returns></returns>
